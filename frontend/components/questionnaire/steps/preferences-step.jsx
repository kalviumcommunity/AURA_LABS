    ...
    <div className="bg-white border border-gray-300 rounded-lg p-8 mt-6">
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup value={data.budgetRange} onValueChange={(value) => updateData({ budgetRange: value })}>
        ...
        <div className="space-y-4">
          ...
          <RadioGroup value={data.studyMode} onValueChange={(value) => updateData({ studyMode: value })}>
