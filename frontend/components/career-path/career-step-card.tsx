import type { CareerStep } from "@/types/career-path"
...
export function CareerStepCard({ step, isActive, isCompleted, stepNumber }: CareerStepCardProps) {
  ...
  const getStepColor = (type: CareerStep["type"]) => {
    switch (type) {
      case "education":
        return "bg-blue-500"
      case "experience":
